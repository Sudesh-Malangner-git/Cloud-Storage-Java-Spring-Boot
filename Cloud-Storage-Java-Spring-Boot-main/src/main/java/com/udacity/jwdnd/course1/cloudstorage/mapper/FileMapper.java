...
public interface FileMapper {
	...
	@Select("SELECT f.fileid, f.filename, f.contenttype, f.filesize, f.userid, f.filedata, u.username AS ownerUsername " +
			"FROM FILES f LEFT JOIN USERS u ON f.userid = u.userid ORDER BY f.fileid DESC")
